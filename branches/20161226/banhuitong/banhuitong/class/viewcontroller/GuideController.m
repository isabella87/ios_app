...
- (void)viewDidLoad
{
    ...
    UIImageView* imageView1 = [[UIImageView alloc] initWithFrame:CGRectMake(0, bounds.origin.y + 10, bounds.size.width, bounds.size.height)];
    [imageView1 setImage:[UIImage imageNamed:@"launch.jpg"]];
    imageView1.image = [Utils cutImage:imageView1.image];
    
    UIImageView* imageView2 = [[UIImageView alloc] initWithFrame:CGRectMake(bounds.size.width, bounds.origin.y + 10, bounds.size.width, bounds.size.height)];
    [imageView2 setImage:[UIImage imageNamed:@"guide1.jpg"]];
    imageView2.image = [Utils cutImage:imageView2.image];
    
    UIImageView* imageView3 = [[UIImageView alloc] initWithFrame:CGRectMake(bounds.size.width*2, bounds.origin.y + 10, bounds.size.width, bounds.size.height)];
    [imageView3 setImage:[UIImage imageNamed:@"guide2.jpg"]];
    imageView3.image = [Utils cutImage:imageView3.image];
    
    UIImageView* imageView4 = [[UIImageView alloc] initWithFrame:CGRectMake(bounds.size.width*3, bounds.origin.y + 10, bounds.size.width, bounds.size.height)];
    [imageView4 setImage:[UIImage imageNamed:@"guide3.jpg"]];
    imageView4.image = [Utils cutImage:imageView4.image];
    ...
    //创建UIScrollView
    self.scrView = [[UIScrollView alloc] initWithFrame:CGRectMake(bounds.origin.x, bounds.origin.y + 10, bounds.size.width, bounds.size.height)];
...
-(void)entry:(id)sender{
    ...
    WelcomeController *controller = (WelcomeController *)[Utils getControllerFromStoryboard:@"WelcomeVC"];
