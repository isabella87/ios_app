...
- (void)viewDidLoad {
    ...
    NSString *address = [NSString stringWithFormat:@"%@app/credit-assign-view.html?id=%d&hash=%@&random=%d", MOBILE_ADDRESS, self.pId, self.myHash, x];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    if ([currentURL containsString:@"login.html"]) {
    ...
    }else if ([currentURL containsString:@"accountment.html"] || [currentURL containsString:@"credit-assign-list.html"]) {
        ...
        if ([currentURL containsString:@"accountment.html"] || [currentURL containsString:@"credit-assign-list.html"]){
            _bridge = nil;
            self.wvDetail.delegate = nil;
