...
@interface MyBaoTableViewCell3 : UITableViewCell
...
@property (strong, nonatomic) IBOutlet UILabel *lblholdDays;
@property (strong, nonatomic) IBOutlet UILabel *lblStype;
@property (strong, nonatomic) IBOutlet UILabel *lblholdDaysName;
